...
export function StorefrontCart() {
  ...
  const onPlace = () =>
    place.mutate(
      { items: items.map((i) => ({ product_id: i.product.id, quantity: i.quantity })), deliveryAddress: address || undefined, notes: notes || undefined },
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      <Card className="space-y-4">
        ...
        {!isAuthenticated ? (
          <div className="space-y-3 rounded-[var(--radius-sm)] border border-border bg-surface-2 p-4 text-center">
